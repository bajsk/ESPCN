...
if __name__=="__main__":
    ...
    img_list = [transform_img(espcn_img(img_path, espcn_model)) for img_path in img_path_list]

    instance_img_path = Config.image_dir + "/fast_mask_roi_11.jpg"
    instance_img_torch = Variable(transform_img(espcn_img(instance_img_path, espcn_model))).cuda()
